...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __Vdly__top__DOT__ARVALID;
    };
    struct {
        CData/*0:0*/ __Vdly__top__DOT__RREADY;
        ...
        IData/*31:0*/ __Vdly__top__DOT__ARADDR;
        IData/*31:0*/ __Vdly__top__DOT__IFU_init__DOT__araddr_latched;
