...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__IFU_init__DOT__state = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__IFU_init__DOT__ifu_reqValid = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__IFU_init__DOT__ifu_respValid = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__IFU_init__DOT__ifu_resqValid_r = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__IFU_init__DOT__resp_cnt = VL_RAND_RESET_I(8);
    ...
    vlSelf->top__DOT__MAU_init__DOT__mem_state = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__MAU_init__DOT__lsu_respValid = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__MAU_init__DOT__lsu_respValid_r = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__MAU_init__DOT__req_d = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__MAU_init__DOT__req_dd = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__MAU_init__DOT__resp_cnt = VL_RAND_RESET_I(8);
    ...
    vlSelf->__Vdly__top__DOT__inst = VL_RAND_RESET_I(32);
