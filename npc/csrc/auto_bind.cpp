...
void nvboard_bind_all_pins(VysyxSoCFull* top) {
	...
	nvboard_bind_pin( &top->externalPins_gpio_seg_0, 8, DEC0P, SEG0G, SEG0F, SEG0E, SEG0D, SEG0C, SEG0B, SEG0A);
	nvboard_bind_pin( &top->externalPins_gpio_seg_1, 8, DEC0P, SEG1G, SEG1F, SEG1E, SEG1D, SEG1C, SEG1B, SEG1A);
	nvboard_bind_pin( &top->externalPins_gpio_seg_2, 8, DEC0P, SEG2G, SEG2F, SEG2E, SEG2D, SEG2C, SEG2B, SEG2A);
	nvboard_bind_pin( &top->externalPins_gpio_seg_3, 8, DEC0P, SEG3G, SEG3F, SEG3E, SEG3D, SEG3C, SEG3B, SEG3A);
	nvboard_bind_pin( &top->externalPins_gpio_seg_4, 8, DEC0P, SEG4G, SEG4F, SEG4E, SEG4D, SEG4C, SEG4B, SEG4A);
	nvboard_bind_pin( &top->externalPins_gpio_seg_5, 8, DEC0P, SEG5G, SEG5F, SEG5E, SEG5D, SEG5C, SEG5B, SEG5A);
	nvboard_bind_pin( &top->externalPins_gpio_seg_6, 8, DEC0P, SEG6G, SEG6F, SEG6E, SEG6D, SEG6C, SEG6B, SEG6A);
	nvboard_bind_pin( &top->externalPins_gpio_seg_7, 8, DEC0P, SEG7G, SEG7F, SEG7E, SEG7D, SEG7C, SEG7B, SEG7A);
