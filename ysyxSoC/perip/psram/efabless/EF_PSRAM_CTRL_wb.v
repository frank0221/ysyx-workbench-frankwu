...
module EF_PSRAM_CTRL_wb (
    ...
    assign sck  = qpi_en ? qpi_sck : wb_we ? mw_sck  : mr_sck;
    assign ce_n = qpi_en ? qpi_ce_n: wb_we ? mw_ce_n : mr_ce_n;
    assign dout = qpi_en ? qpi_dout: wb_we ? mw_dout : mr_dout;
    assign douten  = qpi_en ? {4{qpi_doe}} : wb_we ? {4{mw_doe}}  : {4{mr_doe}};
